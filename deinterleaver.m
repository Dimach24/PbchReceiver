function out_seq = deinterleaver (mode ,in_seq)
    %deinterleaver process of reverse interleaving
    %   mode 0: deinterleaving after polar decoding [7.1.4, TS 38.212]
    %   mode 1: deinterleaving before MIB extracting [7.1.1, TS 38.212]
    ...
    if ~mode % preparing interleaving pattern for mode 0
    ...
    else % preparing interleaving pattern for mode 1
